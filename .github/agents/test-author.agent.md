...
3. Write the output to: `c:\Projects\subagents\artifacts\test_cases.py`
4. Verify the file was written by reading it back
5. Run the tests: `cd c:\Projects\subagents && uv run python -m pytest artifacts\test_cases.py -v`
